...
test_that("autoFIPC validates itemtype length from the old-form matrix branch", {
  skip_if_not_installed("mirt")

  set.seed(366)
  model_data <- mirt::simdata(
    a = matrix(c(0.8, 1.0, 1.2, 0.9), ncol = 1),
    d = c(-0.8, -0.2, 0.4, 1.0),
    itemtype = rep("2PL", 4),
    N = 400
  )
