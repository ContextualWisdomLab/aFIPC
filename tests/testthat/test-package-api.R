...
test_that("autoFIPC executes without errors in non-interactive environment", {
  ...
  dat_old <- mirt::simdata(a = matrix(runif(10, 0.8, 2)), d = matrix(rnorm(10)), N = 100, itemtype = "2PL")
  dat_new <- mirt::simdata(a = matrix(runif(10, 0.8, 2)), d = matrix(rnorm(10)), N = 100, itemtype = "2PL")
