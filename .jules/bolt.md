...
## 2024-07-19 - R Dataframe Dispatch Overhead Optimization
...
**Action:** Always prefer 1D vector subsetting for assignments in R dataframes to avoid performance degradation from method dispatch and memory copies, especially inside iterative processes or large data updates.
