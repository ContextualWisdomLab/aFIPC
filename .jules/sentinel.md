...
**Vulnerability:** (Correctness/Input Validation) Weak regex `^[0-9]+$` on interactive inputs allowed overflow integers, bypassing integer conversion safety boundaries and causing `NA` coercion breakages downstream.
